#ifndef VOXEL_INSTANCER_BLOCKY_H
#define VOXEL_INSTANCER_BLOCKY_H
...
class VoxelTerrain;
class VoxelInstancerBlockyRigidBody;
class PhysicsBody;
...
class VoxelInstancerBlocky : public Spatial, public VoxelInstanceLibrary::IListener {
	GDCLASS(VoxelInstancerBlocky, Spatial)
public:
...
private:
	...
	struct Block {
		...
		Vector<VoxelInstancerBlockyRigidBody *> bodies;
	};
...
VARIANT_ENUM_CAST(VoxelInstancerBlocky::UpMode);

#endif // VOXEL_INSTANCER_BLOCKY_H
